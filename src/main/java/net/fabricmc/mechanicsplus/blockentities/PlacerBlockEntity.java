...
import net.fabricmc.mechanicsplus.blocks.PlacerBlock;
import net.fabricmc.mechanicsplus.helpers.ImplementedInventory;
import net.fabricmc.mechanicsplus.screens.PlacerScreenHandler;
...
public class PlacerBlockEntity extends BlockEntity
  ...
  public PlacerBlockEntity() {
    super(MechanicsPlusMod.PLACER_BLOCK_ENTITY);
  }
